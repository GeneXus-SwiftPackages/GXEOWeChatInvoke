...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.1.0-beta.6.xcframework.zip",
			checksum: "c3788dfbe1a920d5284b040159bb2a237c2fa5c4738ccdf52845caf93605736f"
		)
	]
)