...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-2.0.0-beta.20.xcframework.zip",
			checksum: "ffef0960faccdd6bf043c70623b9001ef6fecb81c68f048ec8b1a18f4d47e632"
		)
	]
)