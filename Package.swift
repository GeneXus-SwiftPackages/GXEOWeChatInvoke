...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/releases/GXEOWeChatInvoke-1.1.2.xcframework.zip",
			checksum: "1323fab3a41acdb1ad20025195d9d1c6d3d3f63ff3e4786319af4fed2dd5af40"
		)
	]
)