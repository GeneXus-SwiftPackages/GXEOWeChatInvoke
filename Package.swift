...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.4.0-beta.13.xcframework.zip",
			checksum: "4aa29a3a36cb112311562be3b33a00901d61547c3184289e23200ee51e68ac0e"
		)
	]
)