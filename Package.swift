...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.0.0-beta.20230613192339.xcframework.zip",
			checksum: "2fda2cc634236e11ad4cfa7dc05d3ee8d04cfcfdfb4f4ea90d43b6835ff3060f"
		)
	]
)