...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.1.0-beta.12.xcframework.zip",
			checksum: "3a5b330f34bae051d29a48d346c2415e1308236761359ca1a783c38e14741f7a"
		)
	]
)