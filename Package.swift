...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.5.0-beta.13.xcframework.zip",
			checksum: "9946a583e6ba0089641ab069b57a578452a32bb14cf843316cbece1e9c9c63a4"
		)
	]
)