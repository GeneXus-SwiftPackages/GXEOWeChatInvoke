...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/preview/GXEOWeChatInvoke-1.2.0-rc.25.xcframework.zip",
			checksum: "739fc3d15fffe25ccff2ea7323ef6927eb488431f68e0830b249819690369982"
		)
	]
)