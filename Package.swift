...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.5.0-beta.28.xcframework.zip",
			checksum: "8f4d274f9081a127327869a6260649d3b1477c85515547ddc32f6ad4ee12bcfa"
		)
	]
)