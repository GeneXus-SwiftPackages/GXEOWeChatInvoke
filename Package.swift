...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-2.0.0-beta.28.xcframework.zip",
			checksum: "859d280855417f595668ecb9511423aac007647ff70a5e8604230b9ce0dfd7cc"
		)
	]
)