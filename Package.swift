...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.2.0-beta.37.xcframework.zip",
			checksum: "11057f1bbf99d16992fae5ba83b12bc7e2a1aa93b4c1186213b005a1654f6b92"
		)
	]
)