...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.0.0-beta.20230615110131.xcframework.zip",
			checksum: "ecc68374224c527a576cffad7963efcbbe44bcc621ff2e10d4388ed5748980bf"
		)
	]
)