...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.4.0-beta.14.xcframework.zip",
			checksum: "83deb12fad5dd4812297dd9c8facfab1167977bb26630bc706797de44bee4a8e"
		)
	]
)