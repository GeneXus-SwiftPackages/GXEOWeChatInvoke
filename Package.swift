...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-2.0.0-beta.31.xcframework.zip",
			checksum: "bc5c9c8a81c792a319fe3a1aeab747ef7cae9f2dfecbe75afeaba1a9209ef0ca"
		)
	]
)