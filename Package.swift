...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/preview/GXEOWeChatInvoke-1.1.0-rc.4.xcframework.zip",
			checksum: "4d660182c57b29a4ce5e5061ec672d5111ba6e2c67550782db47d6279eaa573e"
		)
	]
)