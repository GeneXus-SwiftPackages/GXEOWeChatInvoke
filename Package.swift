...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.5.0-beta.8.xcframework.zip",
			checksum: "426b003bfbd7d3a9e6f9d9f407c246fafd1dd967604d1f11a276adb11fd745c9"
		)
	]
)