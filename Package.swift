...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/preview/GXEOWeChatInvoke-1.3.0-rc.1.xcframework.zip",
			checksum: "06cb90b14125f238b17a5fcc57db340f4039ebc70c73c8e9ff7f5ee448140b41"
		)
	]
)