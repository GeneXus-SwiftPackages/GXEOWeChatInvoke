...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.2.0-beta.1.xcframework.zip",
			checksum: "dc84111c08565dfdeb9b4723047a5a42fb5d4e642b13752953e921e51eae7714"
		)
	]
)