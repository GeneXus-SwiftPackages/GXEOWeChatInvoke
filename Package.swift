...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.1.0-beta.5.xcframework.zip",
			checksum: "8250708ddd5e486619cd5ba1ae841ba20122db87d3e9fe811189bc00c8350c71"
		)
	]
)