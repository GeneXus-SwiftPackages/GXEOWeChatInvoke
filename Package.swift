...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXEOWeChatInvoke",
			url: "https://pkgs.genexus.dev/iOS/beta/GXEOWeChatInvoke-1.5.0-beta.16.xcframework.zip",
			checksum: "b7b4f566be380bb6adff858c91fffb605c56e088af0ab3276c363b782a98385f"
		)
	]
)